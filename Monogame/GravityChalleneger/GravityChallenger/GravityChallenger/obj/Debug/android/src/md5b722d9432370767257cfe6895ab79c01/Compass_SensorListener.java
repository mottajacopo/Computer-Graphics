...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Microsoft.Devices.Sensors.Compass+SensorListener, MonoGame.Framework, Version=3.7.0.1708, Culture=neutral, PublicKeyToken=null", Compass_SensorListener.class, __md_methods);
	}
	...
	public Compass_SensorListener ()
	{
		...
		if (getClass () == Compass_SensorListener.class)
			mono.android.TypeManager.Activate ("Microsoft.Devices.Sensors.Compass+SensorListener, MonoGame.Framework, Version=3.7.0.1708, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
