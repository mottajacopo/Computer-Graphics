package md5b722d9432370767257cfe6895ab79c01;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Microsoft.Devices.Sensors.Accelerometer+SensorListener, MonoGame.Framework, Version=3.7.0.1708, Culture=neutral, PublicKeyToken=null", Accelerometer_SensorListener.class, __md_methods);
	}
	...
	public Accelerometer_SensorListener ()
	{
		...
		if (getClass () == Accelerometer_SensorListener.class)
			mono.android.TypeManager.Activate ("Microsoft.Devices.Sensors.Accelerometer+SensorListener, MonoGame.Framework, Version=3.7.0.1708, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
